...
for i in nation:
    openfile = 'samples_s/Nationalities/' + i + '.csv'
    with open(openfile, 'rb') as f:
        ...
        filename = 'Classifier/Nationality/LogisticRegression/' + i + '.pkl'
        joblib.dump(clf, filename)

        clf = tree.DecisionTreeClassifier()
        clf.fit(X_train, y_train)
        filename = 'Classifier/Nationality/DecisionTree/' + i + '.pkl'
        joblib.dump(clf, filename)

        clf = RandomForestClassifier()
        clf.fit(X_train, y_train)
        filename = 'Classifier/Nationality/RandomForest/' + i + '.pkl'
        joblib.dump(clf, filename)
